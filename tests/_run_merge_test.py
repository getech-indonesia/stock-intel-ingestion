...
assert company.get("ceo") == "Gregory Hendra Lembong", f"ceo was {company.get('ceo')}"
assert "Menara BCA" in (company.get("headquarters") or ""), "headquarters not set"
assert payload.get("shareholders") and len(payload.get("shareholders")) >= 2, "shareholders missing"
print('OK')
